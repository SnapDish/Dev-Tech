...
BLOG_AUTHOR = "The developers of SnapDish"  # (translatable)
BLOG_TITLE = "SnapDish Tech Blog"  # (translatable)
...
BLOG_DESCRIPTION = "This is a memorandum of something technical."  # (translatable)
